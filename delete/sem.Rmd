...
tags$div(style="width:100%; margin:auto auto; fontsize:'20%'",
DiagrammeR("
digraph neato {
           # specifying label position is impossible as long as Diagrammer ignores several label attributes inherent in graphviz
           # Intialization of graph attributes
           graph [overlap=false ordering=out outputorder = edgesfirst splines=false]   # order out keeps observed nodes in order; splines will keep straight after specifying headport
           ...
           subgraph{
            rankdir = LR;
             ...
             Intercept [label='Inter', fontname=Arial, fontcolor=white, fixedsize=true, width=1, height=1, fillcolor='#1f77b480'];  
             Slope [fontname=Arial, fontcolor=white, fixedsize=true, width=1, height=1, fillcolor='#ff7f0e80'];
           }
           ...
           edge [ fontcolor=gray25 dir=both ]  # labeleangle, labeldistance etc. attributes ignored
