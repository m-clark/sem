...
tags$div(style="width:50%; margin:auto auto; font-size:50%",
         DiagrammeR::DiagrammeR('scripts/growth.gv', type='grViz', width='100%', height='25%')
)
...
<img src="http://tidytextmining.com/images/tidyflow-ch-6.png" style="display:block; margin: 0 auto;" width=50%>
...
ggplot(chapters_lda_gamma, aes(gamma, fill = topic)) +
  geom_histogram() +
