...
The above assumes an observed data matrix $X$, where each $n$ observations is of some dimension $m$.  $\Lambda$ is our $m$ by $k$ loading matrix, where $k$ is the number of latent factors, $F$ represents our factors, and $\epsilon$ the noise.
