...
The <span class="pack">ltm</span> package provides some nice decriptives via the <span class="func">descript</span> function.
...
```{r 2pm_ICC, echo=F, dev='svglite', width=4.5, height=3.375}
...
ggplot(aes(x=z, y=Probability), data=iccdat) +
  ...
  annotate(x=-2,y=.15, label='↓', geom='text', size=10, color='#ff5503') +
  xlab('Individual Latent Score') +
  lazerhawk::theme_trueMinimal() +
