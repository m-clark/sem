...
Non-negative matrix factorization is similar to PCA, just with the constraint that scores be positive.  It is (in the usual implementation) identical to probabilistic latent semantic analysis.


### LDA

Latent Dirichlet takes a different approach
