...
r <- Recommender(MovieLense, method = "SVDF")
r
getModel(r)$topN
recom <- predict(r, MovieLense[1], n=5)
recom
...
recom <- predict(r, MovieLense[1:2], type="ratings")
recom
as(recom, "matrix")[,1:10]

recom <- predict(r, MovieLense[1:2], type="ratingMatrix")
recom
as(recom, "matrix")[,1:10]
```
