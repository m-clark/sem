...
The following image, taken from wikipedia, conceptually shows how a *user-based* collaborative filtering method would work, where a recommendation is given based on what other similar users have given.

<img src="https://upload.wikimedia.org/wikipedia/commons/5/52/Collaborative_filtering.gif" style="display:block; margin: 0 auto;" width:50%>
