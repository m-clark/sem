...
The latent linear model versions of PCA and factor analysis assume the latent variables are normal.  This is not required, and ICA, <span class="emph">independent components analysis</span> does not.<span class="marginnote">The visualization duplicates that seen in Murphy (2012).</span>
...
- The ratio of where this isn't applicable to where it is strikes me as very large.
