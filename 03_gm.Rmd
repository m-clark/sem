...
In addition, we'll consider just a single individual, whose observed values are 'control', i.e. 0, 3 for the mediator, and 2 for the target.  We define the unique values %\epsilon$ that represent invariant characteristics regardless of changes to interventions or counterfactual hypotheses and set them to the following:
