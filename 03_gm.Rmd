...
```{r mcclellandCors, echo=F, cache=T, fig.align='center'}
...
<img src="img/iv.png" style="display:block; margin: 0 auto;" width=50%>
...
```{r nonrecursive, echo=F}
tags$div(style="width:500px; margin:0 auto; font-family:Roboto; font-size:50%",
         grViz('scripts/nonrecursive.gv', width=500, height=250)
         )
```
