...
Document: [m-clark.github.io/docs/sem](https://m-clark.github.io/docs/sem)

Data Etc.: [m-clark.github.io/docs/sem/workshop_project.zip](https://m-clark.github.io/docs/sem/workshop_project.zip)
...
- File/Open Project...
- Click on SEM.Rproj
- File/Open/install_script.R

## Exercises

For exercises, open the exercises.nb.html 

***with your browser!***

Or go to: 

[m-clark.github.io/docs/sem/exercises.nb.html](http://m-clark.github.io/docs/sem/exercises.nb.html)
...
<p class='fragment emph'>Understanding Correlation</p>
...
<p class='fragment emph' style='text-align:center; font-size:150%'>Just because it sounds cool or interesting</p>


## Reasons NOT to do SEM {data-transition=fade}

<p class='fragment emph' style='text-align:center; font-size:150%'>Just because you see it in a paper</p>
