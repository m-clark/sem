...
digraph Factor  {
 ...
 node [fontname=Roboto fontsize=32 shape=circle width=.5 color=gray75 fontcolor=gray25];
...
When would you use ICA? If you believe that truly independent sources of signal underlie your data, and that those sources are not normally distributed. It is commonly applied to deal with images or sound.
